/**
 * Studies Services - Application Layer Export
 *
...
/**
 * Studies Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for studies domain.
 */
