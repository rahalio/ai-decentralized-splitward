/**
 * TrainingRounds Services - Application Layer Export
 *
...
/**
 * TrainingRounds Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for training-rounds domain.
 */
