/**
 * RightsExclusions Services - Application Layer Export
 *
...
/**
 * RightsExclusions Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for rights-exclusions domain.
 */
