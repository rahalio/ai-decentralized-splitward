/**
 * RightsExclusions Domain
 *
 * Barrel export for rights-exclusions service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { rights-exclusionsService } from './rights-exclusions.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { rights-exclusionsFacade } from './facade';
...
} from './rights-exclusions.api-types';
