/**
 * ContributionCredits Domain
 *
 * Barrel export for contribution-credits service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { contribution-creditsService } from './contribution-credits.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { contribution-creditsFacade } from './facade';
...
} from './contribution-credits.api-types';
