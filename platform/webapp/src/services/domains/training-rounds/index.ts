/**
 * TrainingRounds Domain
 *
 * Barrel export for training-rounds service, types, hooks, and view models.
 *
 * Architecture Rules:
...
// ============================================================================
export { training-roundsService } from './training-rounds.service';

// ============================================================================
// Facade (high-level API for components)
// ============================================================================
export { training-roundsFacade } from './facade';
...
} from './training-rounds.api-types';
