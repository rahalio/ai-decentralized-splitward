...
export const ZodSitId = createDomainIdValidator('sit', 'Site ID');
export const ZodStuId = createDomainIdValidator('stu', 'Study ID');
export const ZodRndId = createDomainIdValidator('rnd', 'Round ID');
export const ZodCrdId = createDomainIdValidator('crd', 'Credit ID');
export const ZodIncId = createDomainIdValidator('inc', 'Incident ID');
export const ZodRelId = createDomainIdValidator('rel', 'Release ID');
export const ZodLdsId = createDomainIdValidator('lds', 'Dataset ID');
export const ZodRexId = createDomainIdValidator('rex', 'Exclusion ID');
export const ZodAudId = createDomainIdValidator('aud', 'Audit pack ID');
