...
export type IncidentHaltStudyRequest = components["schemas"]["IncidentHaltStudyRequest"];
...
export type OpenIncidentRequestInput = NonNullable<operations["openIncident"]["requestBody"]>["content"]["application/json"];
export type HaltStudyForIncidentRequestInput = NonNullable<operations["haltStudyForIncident"]["requestBody"]>["content"]["application/json"];
...
export type HaltStudyForIncidentParams = operations["haltStudyForIncident"]["parameters"]["path"];
...
export type OpenIncidentResponse = operations["openIncident"]["responses"]["201"]["content"]["application/json"];
export type GetIncidentResponse = operations["getIncident"]["responses"]["200"]["content"]["application/json"];
export type HaltStudyForIncidentResponse = operations["haltStudyForIncident"]["responses"]["200"]["content"]["application/json"];
